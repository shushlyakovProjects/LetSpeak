  ...
  return (
    <div className={style["wrapper-conference"]}>
      <div className={style["conference__friend"]}>
        <p ref={props.myFriendStatusRef}>Ваш собеседник:</p>
        <h2 id="conference__friend-indicator" ref={props.myFriendIndicatorRef} title="Не подключен">
          {props.friendForCall ? props.friendForCall.UserName : ""}
        </h2>
      </div>

      <div
        id="conference__my-indicator"
        className={style["conference__indicator"]}
        ref={props.myVoiceIndicatorRef}
      ></div>
